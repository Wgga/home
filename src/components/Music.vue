		...
		<div class="menu">
			...
			<div class="volume" v-show="volumeShow">
				<div class="icon">
					...
					<volume-small theme="filled" size="24" fill="#efefef"
		...
		<div class="music-list" v-show="musicListShow" @click="closeMusicList()">
			<Transition name="zoom">
				<div class="list" v-show="musicListShow" @click.stop>
					...
					<Player ref="playerRef" :songServer="playerData.server" :songType="playerData.type"
						:songId="playerData.id" :volume="volumeNum" />
				</div>
			</Transition>
		</div>
	</Transition>
